  ...
  return (
    <div className="flex flex-col items-start gap-1">
      ...
      {showGuide && (
        ...
        >
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl relative text-slate-200 animate-in zoom-in-95 duration-200">
            {/* Tombol Tutup Silang */}
            <button
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5 text-xs text-slate-400 font-mono">
                  <span className="text-emerald-400 font-medium">Versi: v1.0</span>
                  <span>•</span>
                  <span>Rilis: 15 Sep 2026</span>
                  <span>•</span>
                  <span>Ukuran: 9.7 MB</span>
                </div>
              </div>
            </div>
            ...
            {activeTab === 'usb' && (
              <div className="space-y-3 text-xs text-slate-300 max-h-[380px] overflow-y-auto pr-1">
